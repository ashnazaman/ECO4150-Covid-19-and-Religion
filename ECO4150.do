...
//Using other Books of the Bible - Pre-Post Analysis 
reg Bookof Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b1
reg ActsoftheApostles Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b2 
reg EpistletotheRomans Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b3 
reg GospelofMark Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b4
reg FirstEpistletotheCorinthians Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b5
reg SecondEpistletotheCorinthian Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State //significant results 
eststo b6
reg EpistletotheGalatians Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b7
reg EpistletotheEphesians Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b8
reg EpistletothePhilippians Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b9
reg EpistletotheColossians Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b10
reg FirstEpistletotheThessalonia Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State //significant results 
eststo b11
reg SecondEpistletotheThessaloni Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b12
reg PremiÃrelettreÃTimothÃe Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b13
reg SecondEpistletoTimothy Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b14
reg EpistletoTitus Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b15
reg EpistletoPhilemon Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b16
reg EpistletotheHebrews Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b17
reg EpistleofJames Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b18
reg FirstEpistleofPeter Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b19
reg SecondEpistleofPeter Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b20
reg FirstEpistleofJohn Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b21
reg SecondEpistleofJohn Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b22
reg ThirdEpistleofJohn Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b23
reg EpistleofJude Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State 
eststo b24
esttab b1 b2 b3 b4 b5 using otherbooks.tex, replace se noobs notes label title(Other Books of the Bible\label{tab1})
esttab b6 b7 b8 b9 b10 using otherbooks2.tex, replace se noobs notes label title(Other Books of the Bible\label{tab1})
esttab b11 b12 b13 b14 b15 using otherbooks3.tex, replace se noobs notes label title(Other Books of the Bible\label{tab1})
esttab b16 b17 b18 b19 b20 using otherbooks4.tex, replace se noobs notes label title(Other Books of the Bible\label{tab1})
esttab b21 b22 b23 b24 using otherbooks5.tex, replace se noobs notes label title(Other Books of the Bible\label{tab1})


//significant books are the second epistle to the corinthians and first epistle to the tessalonians 

xtline SecondEpistletotheCorinthian if State==5 | State==44 | State ==10 | State ==33, tline(1mar2020)

xtline FirstEpistletotheThessalonia if State==5 | State==44 | State ==10 | State ==33, tline(1mar2020)

keep if Date >= td(01mar2006)
...
//IMPORT METRO LEVEL DATA
clear
import excel "/Users/ashnaareeb/Desktop/ECO4150/Metro Level Data.xlsx", sheet("Other Books-Metro Level") firstrow
...
//TABLE 10 
//Running a regression using County level emergency dates on each metro area 
xtdidregress (SecondEpistletotheCorinthian) (CountyEmergencyDate), group(County) time(Date) nogteffects //No time effects
eststo metro4 
xtdidregress (SecondEpistletotheCorinthian) (CountyEmergencyDate), group(Metroarea) time(Date) //Including time effects
eststo metro5
...
//----------------------------- OLD TESTAMENT PRE - POST ANALYIS -------------------------------
clear 
...
//Using other Books of the Bible - Pre-Post Analysis OLD TESTAMENT 
reg BookofGenesis Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b1
reg BookofExodus Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b2
reg BookofLeviticus Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b3
reg BookofNumbers Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b4
reg BookofDeuteron Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State //significant lockdown 
eststo b5
reg BookofJoshua Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b6
reg BookofJudges Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b7
reg BookofRuth Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b8
reg BooksofSamuel Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b9
reg BooksofKings Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State //significant 
eststo b10
reg BooksofChronicles Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State //significant 
eststo b11
reg BookofEzra Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b12
reg BookofNehemiah Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b13
reg BookofEsther Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b14
reg BookofJob Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b15
reg Psalms Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State //signficant 
eststo b16
reg BookofProverbs Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State //significant 
eststo b17
reg Ecclesiastes Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b18
reg SongofSongs Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b19
reg Isaiah Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b20
reg BookofJeremiah Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b21
reg BookofLamentations Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b22
reg BookofEzekiel Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b23
reg BookofHosea Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b24
reg BookofJoel Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b25
reg BookofAmos Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b26
reg BookofObadiah Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b27 
reg BookofJonah Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b28
reg BookofMicah Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b29
reg BookofNahum Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State //significant 
eststo b30
reg BookofHabakkuk Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State //significant 
eststo b31
reg BookofZephaniah Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b32 
reg BookofHaggai Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b33
reg BookofZechariah Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b34
reg BookofMalachi Lockdown Belt Prayer Religion i.NRegion Belt#Lockdown Prayer#Lockdown Religion#Lockdown i.Months i.State
eststo b35


esttab b1 b2 b3 b4 b5 using old1.tex, replace se noobs notes label title(The National Lockdown and the Old Testament \label{tab1})
esttab b6 b7 b8 b9 b10 using old2.tex, replace se noobs notes label title(The National Lockdown and the Old Testament \label{tab1})
esttab b11 b12 b13 b14 b15 using old3.tex, replace se noobs notes label title(The National Lockdown and the Old Testament \label{tab1})
esttab b16 b17 b18 b19 b20 using old4.tex, replace se noobs notes label title(The National Lockdown and the Old Testament \label{tab1})
